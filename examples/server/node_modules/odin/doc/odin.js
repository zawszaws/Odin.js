...
define("core/assets/assets", [ "base/class", "base/time", "core/game/config" ], function(Class, Time, Config) {
    /**
	 * @class Assets
	 * @extends Class
    ...
    Assets.prototype.get = function(name) {
        ...
        asset || console.warn(this + ".get: Assets has no assets named " + name);
        return asset;
    };
    return new Assets();
});
...
define("core/assets/asset", [ "base/class", "core/assets/assets" ], function(Class) {
    /**
	 * @class Asset
	 * @extends Class
...
define("core/assets/spritesheetasset", [ "base/class", "base/dom", "core/assets/asset" ], function(Class, Dom, Asset) {
    /**
    ...
    SpriteSheetAsset.prototype.load = function(callback) {
        var self = this;
        ajax(this.src, function(responseText) {
...
define("core/components/camera2d", [ "base/class", "math/mathf", "math/mat32", "math/mat4", "core/components/component" ], function(Class, Mathf, Mat32, Mat4, Component) {
    /**
	 * @class Camera2D
	 * @extends Component
...
define("core/components/particle2d", [ "base/class", "math/color", "math/vec2" ], function(Class, Color, Vec2) {
    /**
	 * @class Particle2D
	 * @extends Class
	 * @brief 2D particle for Emitter2D Component
	 */
    function Particle2D() {
        Class.call(this);
        /**
	    * @property Number position
	    * @brief life of particle, measured in seconds
	    * @memberof Particle2D
	    */
        this.life = 3;
        /**
	    * @property Number size
	    * @brief size of particle
	    * @memberof Particle2D
	    */
        this.size = .25;
        /**
	    ...
	    * @brief angular velocity of particle
	    * @memberof Particle2D
	    */
    ...
    Particle2D.prototype.update = function(dt) {
        var position = this.position, velocity = this.velocity;
        this.time += dt;
        this.time >= this.life && (this.alive = !1);
...
define("core/components/emitter2d", [ "base/class", "base/objectpool", "math/mathf", "math/color", "math/vec2", "core/components/component", "core/components/particle2d" ], function(Class, ObjectPool, Mathf, Color, Vec2, Component, Particle2D) {
    /**
	 * @class Emitter2D
	 * @extends Component
    ...
    function Emitter2D(opts) {
	    ...
	    * @brief the max number of particles allowed, defaults to 512
	    * @memberof Emitter2D
	    */
        this.maxParticles = void 0 !== opts.maxParticles ? opts.maxParticles : 128;
        /**
	    * @property Boolean emit
	    * @brief should particles be automatically emitted each frame
	    * @memberof Emitter2D
	    */
        this.emit = void 0 !== opts.emit ? !!opts.emit : !0;
        /**
	    * @property Number minSize
	    * @brief minimum size each particle can be at the time when it is spawned
	    * @memberof Emitter2D
	    */
        this.minSize = void 0 !== opts.minSize ? opts.minSize : 1;
        /**
	    * @property Number maxSize
	    * @brief maximum size each particle can be at the time when it is spawned
	    * @memberof Emitter2D
	    */
        this.maxSize = void 0 !== opts.maxSize ? opts.maxSize : 1;
        /**
	    * @property Number minEnergy
	    * @brief minimum lifetime of each particle, measured in seconds
	    * @memberof Emitter2D
	    */
        this.minEnergy = void 0 !== opts.minEnergy ? opts.minEnergy : 1;
        /**
	    * @property Number minEnergy
	    * @brief maximum lifetime of each particle, measured in seconds
	    * @memberof Emitter2D
	    */
        this.maxEnergy = void 0 !== opts.maxEnergy ? opts.maxEnergy : 1;
        /**
	    * @property Number minEmission
	    * @brief minimum number of particles that will be spawned every second
	    * @memberof Emitter2D
	    */
        this.minEmission = void 0 !== opts.minEmission ? opts.minEmission : 1;
        /**
	    * @property Number maxEmission
	    * @brief maximum number of particles that will be spawned every second
	    * @memberof Emitter2D
	    */
        this.maxEmission = void 0 !== opts.maxEmission ? opts.maxEmission : 1;
        /**
	    * @property Vec2 velocity
	    * @brief starting speed of the particles
	    * @memberof Emitter2D
	    */
        this.velocity = void 0 !== opts.velocity ? opts.velocity : new Vec2(0, 1);
        /**
	    * @property Vec2 randVelocity
	    * @brief random speed along x and y that is added to the velocity
	    * @memberof Emitter2D
	    */
        this.randVelocity = void 0 !== opts.randVelocity ? opts.randVelocity : new Vec2();
        /**
	    * @property Number randAngularVelocity
	    * @brief random angular velocity that is added to the angular velocity
	    * @memberof Emitter2D
	    */
        this.randAngularVelocity = void 0 !== opts.randAngularVelocity ? opts.randAngularVelocity : 0;
        /**
	    * @property Number angularVelocity
	    * @brief starting angular speed of the particles
	    * @memberof Emitter2D
	    */
        this.angularVelocity = void 0 !== opts.angularVelocity ? opts.angularVelocity : 0;
        /**
	    * @property Array particles
	    * @brief array holding all active particles
	    * @memberof Emitter2D
	    */
        this.particles = [];
    }
    var particlePool = new ObjectPool(Particle2D), randInt = Mathf.randInt, random = Math.random;
    ...
    Emitter2D.prototype.init = function() {
        var particle, pvelocity, gameObject = this.gameObject, transform = gameObject.transform2d, velocity = this.velocity, randVelocity = this.randVelocity, num = randInt(this.minEmission, this.maxEmission), particles = this.particles;
        if (transform && !this.emit) for (;num--; ) {
            particle = particlePool.create();
            pvelocity = particle.velocity;
            particle.time = 0;
            particle.alive = !0;
            particle.life = randInt(this.minEnergy, this.maxEnergy);
            particle.position.set(0, 0);
            particle.rotation = 0;
            pvelocity.x = velocity.x + randVelocity.x * random();
            pvelocity.y = velocity.y + randVelocity.y * random();
            particle.angularVelocity = this.angularVelocity + random() * this.randAngularVelocity;
    ...
    Emitter2D.prototype.update = function() {
        var particle, pvelocity, i, gameObject = this.gameObject, transform = gameObject.transform2d, velocity = this.velocity, randVelocity = this.randVelocity, num = randInt(this.minEmission, this.maxEmission), particles = this.particles;
        this._buffer;
        if (transform) {
            if (this.emit) for (;num--; ) {
                particle = particlePool.create();
                pvelocity = particle.velocity;
                particle.time = 0;
                particle.alive = !0;
...
define("core/components/rigidbody2d", [ "base/class", "math/vec2", "core/components/component" ], function(Class, Vec2, Component) {
    /**
	 * @class RigidBody2D
	 * @extends Component
    ...
    RigidBody2D.prototype.init = function() {
        var i, body = this.body, shapes = body.shapes, gameObject = this.gameObject, transform = gameObject.transform2d || gameObject.transform3d, bpos = body.position, tpos = transform.position, trot = transform.rotation;
        bpos.x = tpos.x;
        bpos.y = tpos.y;
        body.rotation = trot;
        for (i = shapes.length; i--; ) shapes[i].calculateAABB();
    };
    /**
	 * @method update
	 * @memberof RigidBody2D
...
define("core/components/sprite2d", [ "base/class", "base/time", "math/vec2", "core/components/component" ], function(Class, Time, Vec2, Component) {
    /**
	 * @class Sprite2D
	 * @extends Component
    ...
    function Sprite2D(opts) {
	    ...
	    * @memberof Sprite2D
	    */
        opts.animations && opts.animations.data && (opts.animations = opts.animations.data);
    ...
    Sprite2D.prototype.update = function() {
        var currentFrame, animation = this.animations[this.animation], frame = this._frame, frames = animation.length - 1, order = this._order, mode = this.mode, currentFrame = animation[frame], frameTime = currentFrame[4];
        if (this.playing) {
...
define("core/components/transform2d", [ "base/class", "math/mathf", "math/vec2", "math/mat32", "math/mat4", "core/components/component" ], function(Class, Mathf, Vec2, Mat32, Mat4, Component) {
    /**
	 * @class Transform2D
	 * @extends Component
...
define("core/renderers/canvasrenderer2d", [ "base/class", "base/dom", "base/device", "base/time", "core/canvas", "math/color", "math/mat32" ], function(Class, Dom, Device, Time, Canvas, Color, Mat32) {
    /**
    ...
    var PI = (Time.now, Math.PI), TWO_PI = 2 * PI, defaultImage = new Image();
    ...
    CanvasRenderer2D.prototype.render = function() {
        ...
        return function(scene, camera) {
            var component, i, self = this, background = scene.world.background, ctx = this.context, components = scene.components, rects = (components.Circle2D, 
            components.Poly2D, components.Rect2D);
            components.Sprite2D, components.Renderable2D;
            ...
            if (lastCamera !== camera) {
                var canvas = this.canvas, ipr = 1 / this.pixelRatio, hw = (canvas.width * ipr, canvas.height * ipr, 
                .5 * canvas.width), hh = .5 * canvas.height;
                ctx.translate(hw, hh);
                ctx.scale(hw, hh);
                camera.width = hw;
                camera.height = hh;
            ...
            if (rects) for (i = rects.length; i--; ) {
                component = rects[i];
                component.visible && this.renderComponent(component, camera);
            }
        };
    }();
    CanvasRenderer2D.prototype.renderComponent = function() {
        ...
        return function(component, camera) {
            var sleepState, vertex, x, y, i, ctx = this.context, images = this._data.images, gameObject = component.gameObject, transform = gameObject.transform2d, offset = component.offset, imageSrc = component.image, radius = component.radius, extents = component.extents, vertices = component.vertices, body = component.body, image = images[imageSrc];
            if (!image && imageSrc) if ("default" === imageSrc) image = images["default"]; else {
                image = new Image();
                image.src = imageSrc;
                images[imageSrc] = image;
            }
            model.copy(transform.matrixWorld);
            modelView.mmul(model, camera.matrixWorldInverse);
            modelViewProj.mmul(modelView, camera.matrix);
            ctx.save();
            ...
            if (radius || extents || vertices) {
                ...
                if (component.line) {
                    ...
                    ctx.lineWidth = component.lineWidth || 1 / this.pixelRatio;
                }
                ctx.beginPath();
                if (radius) {
...
define("core/renderers/webglrenderer2d", [ "base/class", "base/dom", "base/device", "core/canvas", "math/mathf", "math/color", "math/vec2", "math/mat32", "math/mat4", "core/components/emitter2d", "core/components/sprite2d" ], function(Class, Dom, Device, Canvas, Mathf, Color, Vec2, Mat32, Mat4, Emitter2D, Sprite2D) {
    ...
    function particleVertexShader(precision) {
        return [ "precision " + precision + " float;", "attribute vec2 aVertexPosition;", "uniform mat4 uMatrix;", "uniform vec2 uPosition;", "uniform float uSize;", "void main(){", "gl_PointSize = uSize;", "gl_Position = uMatrix * vec4( aVertexPosition, 0.0, 1.0 );", "}" ].join("\n");
    }
    ...
    function WebGLRenderer2D(opts) {
	    ...
	    */
        this.pixelRatio = (void 0 !== opts.pixelRatio ? opts.pixelRatio : 64) * Device.pixelRatio;
        /**
	    * @property Canvas canvas
	    * @brief Canvas Class
	    * @memberof WebGLRenderer2D
    ...
    WebGLRenderer2D.prototype.setDefault = function() {
        ...
        return function() {
            var precision, gl = this.context, glData = this.glData, gpu = this.gpu, particle = glData.particle, sprite = glData.sprite;
            this.getExtensions();
            ...
            particle.vertexShader = particleVertexShader(precision);
            particle.fragmentShader = particleFragmentShader(precision);
            particle.program = createProgram(gl, particle.vertexShader, particle.fragmentShader);
            parseUniformsAttributes(gl, particle);
    ...
    WebGLRenderer2D.prototype.renderSprite = function(sprite, mvp) {
        ...
        if (imageAsset) {
            ...
            gl.uniform2f(uniforms.uScale, width, height);
...
define("input/buttons", [ "base/class", "base/time" ], function(Class, Time) {
    function Button() {
        this.timeDown = -1;
        this.timeUp = -1;
        this.frameDown = -1;
...
define("input/input", [ "base/class", "base/dom", "base/time", "math/mathf", "math/vec2", "math/vec3", "input/axis", "input/buttons" ], function(Class, Dom, Time, Mathf, Vec2, Vec3, Axis, Buttons) {
    /**
	 * @class Input
	 * @extends Class
    ...
    Input.prototype.update = function() {
        var button, altButton, name, axis, value, pos, neg, axes = this.axes, list = Buttons.list, dt = Time.delta;
        ...
        for (name in axes) {
            ...
            pos || neg || (value -= clamp(sign(value) * axis.gravity * dt, -1, 1));
...
define("core/game/game", [ "base/class", "base/dom", "base/time", "input/input", "core/assets/assets", "core/game/config", "core/renderers/canvasrenderer2d", "core/renderers/webglrenderer2d" ], function(Class, Dom, Time, Input, Assets, Config, CanvasRenderer2D, WebGLRenderer2D) {
    /**
	 * @class Game
	 * @extends Class
    ...
    function Game(opts) {
        opts || (opts = {});
        Class.call(this);
        Config.debug = void 0 !== opts.debug ? !!opts.debug : !1;
        Config.forceCanvas = void 0 !== opts.forceCanvas ? !!opts.forceCanvas : !1;
        /**
...
define("core/gameobject", [ "base/class" ], function(Class) {
    /**
	 * @class GameObject
	 * @extends Class
...
define("core/scene", [ "base/class", "core/world/world" ], function(Class, World) {
    /**
	 * @class Scene
	 * @extends Class
...
define("odindoc", [ "require", "base/class", "base/device", "base/dom", "base/objectpool", "base/time", "base/utils", "math/aabb2", "math/aabb3", "math/color", "math/line2", "math/mat2", "math/mat3", "math/mat32", "math/mat4", "math/mathf", "math/quat", "math/vec2", "math/vec3", "math/vec4", "core/assets/asset", "core/assets/assets", "core/assets/imageasset", "core/assets/spritesheetasset", "core/components/camera2d", "core/components/component", "core/components/emitter2d", "core/components/rigidbody2d", "core/components/sprite2d", "core/components/transform2d", "core/renderers/canvasrenderer2d", "core/renderers/webglrenderer2d", "core/world/world", "core/game/game", "core/game/config", "core/canvas", "core/gameobject", "core/scene", "input/input" ], function(require) {
	...
	*/
    ...
    Odin.Emitter2D = require("core/components/emitter2d");
    ...
    Odin.Input = require("input/input");
    return Odin;
});